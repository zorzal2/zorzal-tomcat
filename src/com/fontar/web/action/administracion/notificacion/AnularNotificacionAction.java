...
/**
 * Action para anular una <code>Notificacion</code>.<br>
 * @author ssanchez
 */
public class AnularNotificacionAction extends NotificacionBaseTaskAction {
	...
	/**
	 * Anula la <code>Notificacion</code>.<br>
	 */
	protected void executeEjecutarYTerminarTarea(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		wfNotificacionServicio.anularNotificacion(idTaskInstance,notificacionDTO.getObservacion());
	}
