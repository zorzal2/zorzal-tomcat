...
public class SolicitarReadmisibilidadAction extends ProyectoBaseTaskAction {
	...
	protected void executeCargarTarea(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		request.setAttribute("idProyecto", proyectoDTO.getCodigo());
	}
	...
	protected void executeEjecutarYTerminarTarea(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		wfProyectoServicio.solicitarReadmisionAlProyecto( fecha, observacion, idTaskInstance);
	}
}