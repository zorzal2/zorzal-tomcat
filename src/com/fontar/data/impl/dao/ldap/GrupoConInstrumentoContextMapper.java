 ...
 */
public class GrupoConInstrumentoContextMapper implements ContextMapper {

	
    LdapOperations ldapOperations;
    
    public GrupoConInstrumentoContextMapper(LdapOperations ldapOperations) {
		this.ldapOperations= ldapOperations;
	}
    
    public GrupoConInstrumentoContextMapper() {
	}    
    ...
    public Object mapFromContext(Object ctx) {
        ...
        GrupoConInstrumento group = new GrupoConInstrumento(); 
        ...
        group.setIdInstrumento(new Long(dirContext.getStringAttribute("idInstrumento")));        
        return group;
    }
}
