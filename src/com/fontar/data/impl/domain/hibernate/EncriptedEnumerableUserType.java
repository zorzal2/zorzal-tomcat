...
public class EncriptedEnumerableUserType implements UserType {
	
	
	static final String DEFAULT_VALUE = "No accesible";
	...
	protected void noNullSet(PreparedStatement st, Object value, int index) throws SQLException {
		  st.setBytes(index, getCryptographicService().encrypt( value, this.getClass()));
	}
