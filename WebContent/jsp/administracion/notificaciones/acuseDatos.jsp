...
<table class="formulario">		
	<tr>		
		<th colspan="2" class="titulo">
			<bean:message bundle="headers" key="app.header.fechaRecepcionAcuse" />
		</th>	
	</tr>
	...
	<tr>
		...
		<td>
	   		<pragmatags:calendar propertyName="fechaAcuse" top="210" left="750" />
			<pragmatags:error property="fechaAcuse" />
		</td>
	</tr>
</table>
