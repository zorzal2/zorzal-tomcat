...
<html:form action="/ReconsiderarGuardar">
...
<table class="formulario">
	<tr>
		<td class="obligatorio" width="20%">
			<bean:message bundle="labels" key="app.label.proximoPaso"/>
		</td>		
		<td colspan="2">
			<html:select property="idProximoPaso">
				<html:options collection="proximosPasos" property="value" labelProperty="label"/>
			</html:select>
			<pragmatags:error property="idProximoPaso" />
		</td>
	</tr>		
