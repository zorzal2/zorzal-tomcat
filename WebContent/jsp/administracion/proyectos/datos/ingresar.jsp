...
<html-el:form action="ProyectosExcelCargar.do" method="post" enctype="multipart/form-data">
	<table>
		<tr>
			<td class="error">
		...
		<tr>
			<td class="opcional">
				...
				&nbsp;&nbsp;&nbsp;
				<a type="application/zip" href="./download/Carga Proyectos.zip">Carga Proyectos.zip</a>
			</td>
		</tr>
	</table>
</html-el:form>
