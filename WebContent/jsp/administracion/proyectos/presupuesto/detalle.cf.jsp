...
function verItems(localizacionPresupuesto, rubroId) {
	var url= "PresupuestoDetalleRubrosCF.do?idRubro="+rubroId+"&localizacionPresupuesto="+localizacionPresupuesto;
...
<table width="100%">
	...
	<c:if test="${!empty presupuesto.flujo}">
		...
		<tr>
			<td>
				<display-el:table name="presupuesto.flujo.flujoTotal" class="flujo">
					...
					<display:footer>
						<tr>
					  		...
					  		<td style="text-align: right"><bean:write name="presupuesto" property="flujo.totales.valores[0]" /></td>
					  		<td style="text-align: right"><bean:write name="presupuesto" property="flujo.totales.valores[1]" /></td>
					  		<td style="text-align: right"><bean:write name="presupuesto" property="flujo.totales.valores[2]" /></td>
					  		<td style="text-align: right"><bean:write name="presupuesto" property="flujo.totales.valores[3]" /></td>
					  		<td style="text-align: right"><bean:write name="presupuesto" property="flujo.totales.valores[4]" /></td>
					  		<td style="text-align: right"><bean:write name="presupuesto" property="flujo.totales.valores[5]" /></td>
					  		<td style="text-align: right"><bean:write name="presupuesto" property="flujo.totales.valores[6]" /></td>
					  		<td style="text-align: right"><bean:write name="presupuesto" property="flujo.totales.valores[7]" /></td>
					  		<td style="text-align: right"><bean:write name="presupuesto" property="flujo.totales.valores[8]" /></td>
					  		<td style="text-align: right"><bean:write name="presupuesto" property="flujo.totales.valores[9]" /></td>
					  		<td style="text-align: right"><bean:write name="presupuesto" property="flujo.totales.valores[10]" /></td>
					  		<td style="text-align: right"><bean:write name="presupuesto" property="flujo.totales.valores[11]" /></td>
						<tr>
					</display:footer>
				</display-el:table>
			</td>
