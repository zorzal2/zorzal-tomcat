...
<c:set var="headerKey" value="app.title.altaUsuario" />

<html:form action="UsuariosGuardar.do">
	...
	<table class="formulario">
		...
		<tr>
			...
			<td colspan="5">
	   			...
	   			<pragmatags:error property="user"/>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="5">
	   			<html:password property="appPassword" maxlength="20"/>
	   			<pragmatags:error property="appPassword"/>
			</td>
		</tr>	
		...
		<table id="tablaGrupos" border="0" width="70%" class="inventario">
			...
			<tr>
				<input id="idGrupo" name="idGrupo" value="${grupo.idGrupo}" type="hidden"/>
