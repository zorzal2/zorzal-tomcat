...
<h3>
	<bean:message bundle="titles" key="app.title.entidadesBancarias"/>	
</h3>
<html:form action="/EntidadBancariaConfiguracionInventarioFiltrar">	
	<table class="filtros">
			<tr>
				<td>
	...
	<toolbar:table model="list" requestURI="/EntidadBancariaConfiguracionInventarioFiltrar.do" />	
</html:form>