...
<html:form action="/EntidadBeneficiariaConfiguracionInventarioFiltrar">	
	<table class="filtros">
			<tr>
				<td>				
	...
	<toolbar:table model="list" requestURI="/EntidadBeneficiariaConfiguracionInventarioFiltrar.do" />
</html:form>