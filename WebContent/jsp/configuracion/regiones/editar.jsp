...
<c:set var="headerKey" value="app.title.altaRegion" />
<c:if test="${!empty param.id}" >
	<c:set var="headerKey" value="app.title.edicionRegion" />
</c:if>
...
<pragmatags:btnOkCancel okJavascript="submitForm();" cancelAction="/RegionInventario"/>
</html:form>