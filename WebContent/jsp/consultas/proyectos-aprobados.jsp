...
<html:form action="/EjecutarConsulta" >
	...
	<display-el:table export="true" name="result" requestURI="EjecutarConsulta.do" class="inventario" pagesize="15" decorator="com.fontar.web.decorator.administracion.proyecto.ProyectoWrapper">
		...
		<display-el:setProperty name="basic.show.header" value="true">
			...
			<display-el:caption style="display:none">
			<bean:write name="consulta" property="titulo"/></display-el:caption>
			...
			<display-el:column property="proyectoDatos.personaDirector.cargo" title="Cargo Director" />
			<display-el:column property="proyectoDatos.personaDirector.localizacion.direccion" title="Dirección Director" />
			<display-el:column property="proyectoDatos.personaDirector.localizacion.telefono" title="Teléfono Director" />			
			<display-el:column property="proyectoDatos.personaDirector.localizacion.codigoPostal" title="Código Postal Director" />
			<display-el:column property="proyectoDatos.personaDirector.localizacion.jurisdiccion.codigo" title="Jurisdicción Director" />
			<display-el:column property="proyectoDatos.personaDirector.localizacion.email" title="Mail Director" />
