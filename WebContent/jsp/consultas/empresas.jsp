...
<html:form action="/EjecutarConsulta" >
	...
	<display-el:table export="true" name="result" requestURI="EjecutarConsulta.do" class="inventario" pagesize="15" decorator="com.fontar.web.decorator.administracion.proyecto.ProyectoWrapper">
		...
		<display-el:caption style="display:none"><bean:write name="consulta" property="titulo"/></display-el:caption>	
			...
			<display-el:column  property="montoDesembolsado" title="Monto Desembolsado ($)" style="text-align:right" decorator="com.pragma.toolbar.web.decorator.MoneyWrapper"/>
			<display-el:column  property="montoADesembolsar" title="Monto a Desembolsar ($)" style="text-align:right" decorator="com.pragma.toolbar.web.decorator.MoneyWrapper"/>
			<display-el:column  property="estado" title="Estado del Proyecto"/>
