...
<html:form action="/EjecutarConsulta" >
	...
	<display-el:table export="true" name="result" requestURI="EjecutarConsulta.do" class="inventario" pagesize="15"  decorator="com.fontar.web.decorator.evaluacion.EvaluacionWrapper">
		...
		<display-el:caption style="display:none">
			...
			<display-el:column  property="fecha" decorator="com.pragma.toolbar.web.decorator.ShortDateWrapper" title="Fecha Evaluación"/>
			<display-el:column  property="evaluador" title="Evaluador" decorator="com.fontar.web.decorator.miscelaneos.StringMaxLengthWrapper"/>
			...
			<display-el:column  property="proyecto.proyectoDatos.titulo" title="Titulo"/>
