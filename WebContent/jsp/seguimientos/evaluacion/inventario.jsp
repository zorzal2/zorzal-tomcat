...
<h3><bean:message bundle="titles" key="app.title.evaluacionSeguimiento.evaluacionesSeguimiento" /></h3>

<html:form action="/EvaluacionSeguimientoInventarioFiltrar">
	<table class="filtros">
		<tr>
	...
	<toolbar:table model="list"
		requestURI="/EvaluacionSeguimientoInventarioFiltrar.do" />
</html:form>
