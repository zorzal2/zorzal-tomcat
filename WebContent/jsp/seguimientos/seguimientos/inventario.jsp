...
<h3>
	<bean:message bundle="titles" key="app.title.seguimientos"/>
</h3>

<html:form action="/SeguimientoInventarioFiltrar">
	<table class="filtros">
		<tr>
	...
	<toolbar:table model="list" requestURI="/SeguimientoInventarioFiltrar.do" />	
</html:form>
