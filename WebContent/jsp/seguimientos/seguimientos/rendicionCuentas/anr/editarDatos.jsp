...
<c:if test="${!rubro.esRecursoHumanoPropio}">	
	<tr>
		...
		<td colspan="5">
			<html:text property="montoParte" maxlength="60" style="text-align:right"/>
...
<tr>
	...
	<td colspan="5">
		<html:text property="montoContraparte" maxlength="60" style="text-align:right"/>
		<pragmatags:error property="montoContraparte" />
	</td>
</tr>