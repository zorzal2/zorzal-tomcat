...
<html:form action="/RendicionCuentasANRGuardar">
...
<html:hidden property="id"/>
	...
	<table class="formulario">	
		...
		<tr>
			...
			<td colspan="5">
				<html:select property="idRubro" onchange="javascript:changeFormAction('RendicionCuentasANRAgregar')">
		...
		<pragmatags:btnOkCancel okJavascript="submitForm();" cancelAction="/RendicionCuentasANRInventario"/>
