...
<html:form action="/RendicionCuentasCFInventario">

	<c:if test="${permiteAgregarOQuitarRendiciones}">
		<table>
			<tr valign="top">
				<td><pragmatags:btnAgregar action="/RendicionCuentasCFAgregar" /></td>
				<td>
	...
	<toolbar:table model="list" requestURI="/RendicionCuentasCFInventario.do" />	
