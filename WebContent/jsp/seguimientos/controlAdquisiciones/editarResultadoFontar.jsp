...
<script type="text/javascript">
	...
	window.onload=function() {
		doResultadoChange(document.getElementsByName('resultadoFontar')[0])
	}
</script>

<body>
<html:form action="/GuardarResultadoFontar?id=${id}">
<html:hidden property="id" />

<h3>
	<bean:message bundle="titles" key="app.title.procedimientos.editarResultadoFontar"/>
</h3>	
...
<table class="formulario">
	...
	<tr id="trMonto">
		...
		<td>
			<html:text property="montoFontar" maxlength="20" size="15%" style="text-align:right"/>
			<pragmatags:error property="montoFontar" />
		</td>	
	</tr>		
	<tr>
		<td class="obligatorio">
		...
		<td>
			<html:select onchange="doResultadoChange(this)" property="resultadoFontar">
				<html:options collection="resultados" property="value" labelProperty="label"/>
			</html:select>
			<pragmatags:error property="resultadoFontar" />
		</td>
	</tr>
</table>
