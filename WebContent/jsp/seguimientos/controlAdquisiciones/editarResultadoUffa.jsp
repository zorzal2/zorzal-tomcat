...
<script type="text/javascript">
	...
	window.onload=function() {
		doResultadoChange(document.getElementsByName('resultadoUffa')[0])
	}
</script>

<body>
<html:form action="/GuardarResultadoUffa?id=${id}">
<html:hidden property="id" />

<h3>
	<bean:message bundle="titles" key="app.title.procedimientos.editarResultadoUffa"/>
</h3>	
...
<table class="formulario">
	...
	<tr id="trMonto">
		...
		<td>
			<html:text property="montoUffa" maxlength="20" size="15%" style="text-align:right"/>
			<pragmatags:error property="montoUffa" />
		</td>	
	</tr>		
	<tr>
		<td class="obligatorio">
		...
		<td>
			<html:select onchange="doResultadoChange(this)" property="resultadoUffa">
				<html:options collection="resultados" property="value" labelProperty="label"/>
			</html:select>
			<pragmatags:error property="resultadoUffa" />
		</td>
	</tr>
</table>
