...
<body>
<html:form action="/CargarFundamentacionEvaluadorGuardar">

<table class="formulario">
	<tr>
		<td>
			<pragmatags:btnDynaLabel action="/CargarFundamentacionEvaluadorEditarDatosGestion?id=${id}" label="app.label.editar" />
		</td>
	</tr>
	 
	<tr>
		<th colspan="2" class="titulo" class="obligatorio">
