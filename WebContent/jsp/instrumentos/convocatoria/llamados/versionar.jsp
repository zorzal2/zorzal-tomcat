...
<html:form action="/LlamadoConvocatoriaVersionarFinish">
...
<table class="formulario">
	<tr>
		<th colspan="6" class="titulo"><bean:message bundle="headers" key="app.header.versionLlamadoConvocatoria" /></th>
	</tr>
	<tr>
...
<br>
<br>
	<pragmatags:btnOkCancel okJavascript="submitForm()" cancelAction="/LlamadoConvocatoriaEditar"/>	
</html:form>
