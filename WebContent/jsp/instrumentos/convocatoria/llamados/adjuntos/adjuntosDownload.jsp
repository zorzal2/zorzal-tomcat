...
<h3>
	<bean:message bundle="titles" key="app.title.adjuntos.llamadoConvocatoriaBean"/>
		&nbsp;-&nbsp;
...
<jsp:include page="/jsp/misc/adjuntos/adjuntosDownload.jsp" flush="true">
	<jsp:param name="entityBeanName" value="LlamadoConvocatoriaBean" />
	<jsp:param name="permisoParaAgregar" value="LLAMADOSCONVOCATORIAADJUNTOS-EDITAR" />
</jsp:include>
