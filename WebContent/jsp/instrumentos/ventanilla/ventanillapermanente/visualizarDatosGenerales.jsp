...
<table class="formulario">
	...
	<tr>
		...
		<td class="opcional">
			<bean:write name="instrumento" property="estado.descripcion"/>
		</td>
	</tr>
	...
	<tr>
		...
		<td>
		<button onclick="javascript:popUpMostrarVersionInstrumento('Ventanilla','${instrumento.id}','${instrumento.identificador}');">
	...
	<tr>
		...
		<td class="opcional">
			<html:radio name="instrumento" property="aceptaIdeaProyecto" value="true" disabled="true">
				<bean:message bundle="labels" key="app.label.si"/>
			</html:radio>
			<html:radio name="instrumento" property="aceptaIdeaProyecto" value="false" disabled="true">
				<bean:message bundle="labels" key="app.label.no"/>
			</html:radio>
		</td>
	</tr>	
